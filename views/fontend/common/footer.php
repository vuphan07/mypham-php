<div class="footer">
        ...
        <ul class="footer__list">
          <li class="footer__item">
            <span class="footer__text">
              <i class="fas fa-map-marked-alt"></i> 36 Cầu Diễn, Hà nội
            </span>
          </li>
          <li class="footer__item">
          ...
          <li class="footer__item">
            <a href="#" class="footer__link">
              <i class="fas fa-envelope"></i> luongngoc@gmail.com
            </a>
          </li>
          <li class="footer__item">
  ...
  <div class="copyright">
    <span class="footer__text"> &copy Bản quyền thuộc về <a class="footer__link" href="#">Lương Ngọc</a></span>
  </div>
</div>
...
<!-- Rev slider js -->
<script src="public/assets/js/commonscript.js"></script>
